...
class FeaturePyramid(nn.Module):
    ...
    def __init__(self):
        super().__init__(); self.b1=block(1,64); self.b2=block(64,64)
        self.b3=block(64,128); self.b4=block(128,128); self.pool=nn.MaxPool2d(2)
        init_glorot(self)
    def forward(self, x: torch.Tensor):
        f1=self.b1(x); f2=self.b2(self.pool(f1)); f3=self.b3(self.pool(f2)); f4=self.b4(self.pool(f3))
        return (f1,f2,f3,f4)
