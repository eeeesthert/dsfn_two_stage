...
def main() -> None:
    ...
    ap.add_argument("--dataset-root", default=r"./dataset")
    ap.add_argument("--checkpoint", default=r"./outputs")
    ap.add_argument("--stage", default="12", help="34")
    ...
    ckpt = args.chekpoint + r"/stage_" + args.stage + ".pt"
    ...
    run_stage(model, args.dataset_root, stage=args.stage, out_dir=args.out_dir, image_size=args.image_size, device=device)
