...
def main():
	...
	p.add_argument("--slic-k", type=int, choices=[50, 100, 150, 200, 300, 400, 500])
	a = p.parse_args()
	random.seed(42)
	np.random.seed(42)
	...
	if a.slic_k:
		cfg["slic"]["n_segments"] = a.slic_k
	status = run_pipeline(a.reference, a.target, a.output, cfg, a.mode)
