...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--amp", action="store_true", default=False, help="Enable AMP for convolution-heavy parts. Disabled by default because full-image DLT is fp32-sensitive.")
